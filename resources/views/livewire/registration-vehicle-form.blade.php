                ...
                @if ($isListRegistered)
                    <div class="px-3 py-2 flex flex-col min-h-screen">
                        <div class="flex-shrink-0">
                            ...
                            <div class="mb-4">
                                <div class="relative">
                                    ...
                                    <input type="text" wire:model.live.debounce.500ms="searchDriver"
                                    ...
                                    <div wire:loading wire:target="searchDriver"
                        ...
                        <div class="flex-1 flex flex-col min-h-0">
                            ...
                            <div wire:loading.flex wire:target="searchDriver"
                            ...
                            <div wire:loading.remove wire:target="searchDriver" class="flex-1 flex flex-col">
                                @if (empty($registrations))
                                    <div class="flex-1 flex items-center justify-center py-10">
                                        <p class="text-sm text-gray-500 dark:text-gray-400 italic">Không có đăng ký nào.
                                        </p>
                                    </div>
                                @else
                                    <div class="space-y-3">
                                                        ...
                                                        <div class="flex items-start justify-between gap-3">
                                                            ...
                                                            <div class="flex-shrink-0 text-right">
                                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                                    {{ $reg['expected_in_at'] ?? '' }}</p>
                                                                <div class="mt-2">
                                                                    <span
                                                                        class="inline-flex items-center px-3 py-0.5 rounded-full text-xs font-medium {{ $reg['status_classes'] ?? '' }}">{{ $reg['status_label'] ?? ($reg['status'] ?? '') }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
