...
<body>
    <div class="flex gap-2">
        <!-- LIÊN 1 -->
        <div class="h-70 w-112.5 bg-gray-100 p-1 text-xs">
            <!-- Header -->
            <div class="flex h-10 items-center">
                ...
                <div class="flex-1 text-center font-bold">CÔNG TY CỔ PHẦN ASGL</div>
            </div>
        ...
        {{-- <div class="h-60 w-112.5 bg-gray-100 p-1 text-xs">
            ...
            <div class="space-y-1">
                ...
                <div class="flex h-4 items-center justify-center px-1">
                    <span class="whitespace-nowrap font-bold">Xe ô tô, BKS:</span>
                    <span class="ml-1 w-32 border-b border-dashed border-black text-center font-normal">{{
                        $vehicle_number ?? '' }}</span>
                </div>
                ...
                <div class="flex h-4 items-center justify-center px-1">
                    <span class="whitespace-nowrap font-bold">Tải trọng:</span>
                    <span class="ml-1 w-32 border-b border-dashed border-black text-center font-normal">Xe ô tô dưới
                        1,5T</span>
                </div>
                ...
                <div class="flex h-4 items-center gap-1 px-1">
                    <span class="whitespace-nowrap">Giờ vào:</span>
                    <span class="w-10 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($entry_time)->format('H') }}</span>
                    <span class="whitespace-nowrap">h</span>
                    <span class="whitespace-nowrap">/</span>
                    <span class="w-10 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($entry_time)->format('i') }}</span>

                    <span class="whitespace-nowrap">Ngày:</span>
                    <span class="w-32 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($entry_time)->format('d/m/Y') }}</span>
                </div>
                ...
                <div class="flex h-4 items-center gap-1 px-1">
                    <span class="whitespace-nowrap">Giờ ra:</span>
                    <span class="w-10 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($exit_time)->format('H') }}</span>
                    <span class="whitespace-nowrap">h</span>
                    <span class="whitespace-nowrap">/</span>
                    <span class="w-10 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($exit_time)->format('i') }}</span>

                    <span class="whitespace-nowrap">Ngày:</span>
                    <span class="w-32 border-b border-dashed border-black text-center">{{
                        \Carbon\Carbon::parse($exit_time)->format('d/m/Y') }}</span>
                </div>

                <!-- Tổng thời gian -->
                <div class="flex h-4 items-center px-1">
                    <span class="whitespace-nowrap">Tổng thời gian khai thác:</span>
                    <span class="ml-1 w-32 border-b border-dashed border-black text-center">{{ $total_hours }} giờ / {{
                        $remaining_minutes ?? ($total_minutes % 60) }} phút</span>
                </div>
