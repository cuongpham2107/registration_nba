...
namespace App\Filament\Resources\RegistrationEntries\Filters;
...
class RegistrationEntryFilter extends Filter
{
            ...
            ->query(function (Builder $query, array $data): Builder {
                return $query
                    ...
                    ->when(
                        ...
                        fn (Builder $query) => $query->whereDate('start_date', Carbon::parse($data['start_date'], 'Asia/Ho_Chi_Minh'))
                    )
                    ->when(
                        $data['start_date'] && $data['end_date'],
